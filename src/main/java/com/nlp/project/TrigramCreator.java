...
public class TrigramCreator {
	
	public TrigramCreator() {
	...
	public void createMap() {
		for(int combination = 1; combination <= 5; combination++) {		
					...
					if(!(str.isEmpty() || str.equals("### END ###"))) {
						...
						for(String oneLine : lines) {
							...
							for(int j = 0; j < words.length - 2; j++) {
								String word = words[j] + words[j+1] + words[j+2];									
			...
			String training_file = "iphone-500/training-tri-" + combination + ".arff";
			String test_file = "iphone-500/test-tri-" + combination + ".arff";
			try{
	...
	public static void main(String args[]) {
		TrigramCreator tc = new TrigramCreator();
		tc.createMap();
	}
}
